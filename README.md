...
The reconstruction makes those parts operational again. The 28 damaged functions are represented as data-driven recovered-pass presets instead of duplicated source.
...
The default source is a generated test texture. You can load a local image, select a curve and recovered pass, change the frame-ring depth, history mix and feedback gain, step the timeline, or export the current frame as PNG.
